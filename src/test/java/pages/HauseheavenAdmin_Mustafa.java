...
public class HauseheavenAdmin_Mustafa {

    public HauseheavenAdmin_Mustafa(){
    ...
    @FindBy(xpath = "//*[@id=\"cms-plugins-location\"]/a")
    public WebElement locationMenuAlani;

    @FindBy(xpath = "//*[@id=\"cms-plugins-country\"]/a")
    public WebElement countriesMenuAlani;

    @FindBy(xpath = "//*[@id=\"cms-plugins-state\"]/a")
    public WebElement statesMenuAlani;

    @FindBy(xpath = "//*[@id=\"cms-plugins-city\"]/a")
    public WebElement citiesMenuAlani;
}