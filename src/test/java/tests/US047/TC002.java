...
public class TC002 {
    ...
    public void test01(){
        ...
        hauseheavenAdminPages.packagePriceText.sendKeys(faker.number().numberBetween(1000, 9999) + "");
        ReusableMethods.bekle(2);

        hauseheavenAdminPages.packagePersentSaveText.sendKeys(faker.number().numberBetween(1, 9) + "");
        ReusableMethods.bekle(2);
        ...
        Assert.assertEquals(expectedPackageCreateSayfaUrl,actualSonucMesaji);
        ReusableMethods.bekle(2);
        Driver.quitDriver();
