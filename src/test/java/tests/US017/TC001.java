...
public class TC001 {
    ...
    public void propertiesTest() {
        ...
        Assert.assertTrue(kivanc_hauseheavenPage.mainLogo.isDisplayed());
        Assert.assertTrue(kivanc_hauseheavenPage.mainLogo.isEnabled());

        Assert.assertTrue(kivanc_hauseheavenPage.homeMenu.isDisplayed());
        Assert.assertTrue(kivanc_hauseheavenPage.homeMenu.isEnabled());

        Assert.assertTrue(kivanc_hauseheavenPage.listingMenu.isDisplayed());
        Assert.assertTrue(kivanc_hauseheavenPage.listingMenu.isEnabled());

        Assert.assertTrue(kivanc_hauseheavenPage.projectMenu.isDisplayed());
        Assert.assertTrue(kivanc_hauseheavenPage.projectMenu.isEnabled());

        Assert.assertTrue(kivanc_hauseheavenPage.agentsMenu.isDisplayed());
        Assert.assertTrue(kivanc_hauseheavenPage.agentsMenu.isEnabled());

        Assert.assertTrue(kivanc_hauseheavenPage.blogMenu.isDisplayed());
        Assert.assertTrue(kivanc_hauseheavenPage.blogMenu.isEnabled());

        Assert.assertTrue(kivanc_hauseheavenPage.contactMenu.isDisplayed());
        Assert.assertTrue(kivanc_hauseheavenPage.contactMenu.isEnabled());

        Assert.assertTrue(kivanc_hauseheavenPage.signUpMenu.isDisplayed());
        Assert.assertTrue(kivanc_hauseheavenPage.signUpMenu.isEnabled());

        Assert.assertTrue(kivanc_hauseheavenPage.addProperties.isDisplayed());
        Assert.assertTrue(kivanc_hauseheavenPage.addProperties.isEnabled());

        Assert.assertTrue(kivanc_hauseheavenPage.profilIkon.isDisplayed());
        Assert.assertTrue(kivanc_hauseheavenPage.profilIkon.isEnabled());

        Assert.assertTrue(kivanc_hauseheavenPage.logOut.isDisplayed());
        Assert.assertTrue(kivanc_hauseheavenPage.logOut.isEnabled());
