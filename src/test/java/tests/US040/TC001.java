...
public class TC001 {
    ...
    public void test() {
        ...
        hauseHeaven_gokhan.clickCategories
                .click();
        ...
        hauseHeaven_gokhan.nameTextArea.sendKeys("Village House");
        ...
        Assert.assertTrue(hauseHeaven_gokhan.statusOptions
                .isDisplayed());
        ...
        hauseHeaven_gokhan.nameTextArea
                .clear();
        hauseHeaven_gokhan.nameTextArea.sendKeys("House Village");
