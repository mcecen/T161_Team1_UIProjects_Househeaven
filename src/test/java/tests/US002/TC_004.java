...
public class TC_004 {
    ...
    @Test
    public void userCanAccessHomePageAndTopMenus() throws InterruptedException {
        ...
        Thread.sleep(3000);
        WebElement listingElement = driver.findElement(By.xpath("//a[normalize-space()='Listing']"));
